...
$UpgradeRecordCopyWith<UpgradeRecord> get copyWith => _$UpgradeRecordCopyWithImpl<UpgradeRecord>(this as UpgradeRecord, _$identity);
...
String toString() {
  final _this = this as UpgradeRecord;
  return 'UpgradeRecord(id: ${_this.id}, remoteId: ${_this.remoteId}, vehicleId: ${_this.vehicleId}, date: ${_this.date}, mileage: ${_this.mileage}, description: ${_this.description}, cost: ${_this.cost}, notes: ${_this.notes}, tags: ${_this.tags}, updatedAt: ${_this.updatedAt}, syncStatus: ${_this.syncStatus})';
}
...
/// @nodoc
abstract mixin class $UpgradeRecordCopyWith<$Res>  {
  factory $UpgradeRecordCopyWith(UpgradeRecord value, $Res Function(UpgradeRecord) _then) = _$UpgradeRecordCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$UpgradeRecordCopyWithImpl<$Res>
    implements $UpgradeRecordCopyWith<$Res> {
  _$UpgradeRecordCopyWithImpl(this._self, this._then);

  final UpgradeRecord _self;
  final $Res Function(UpgradeRecord) _then;
...
/// Adds pattern-matching-related methods to [UpgradeRecord].
extension UpgradeRecordPatterns on UpgradeRecord {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UpgradeRecord value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UpgradeRecord() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UpgradeRecord value)  $default,){
final _that = this;
switch (_that) {
case _UpgradeRecord():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UpgradeRecord value)?  $default,){
final _that = this;
switch (_that) {
case _UpgradeRecord() when $default != null:
return $default(_that);case _:
...
class _UpgradeRecord implements UpgradeRecord {
  const _UpgradeRecord({required this.id, this.remoteId, required this.vehicleId, required this.date, this.mileage = 0.0, required this.description, this.cost = 0.0, this.notes = '',  List<String> tags = const [], required this.updatedAt, this.syncStatus = 'synced'}): _tags = tags;
  factory _UpgradeRecord.fromJson(Map<String, dynamic> json) => _$UpgradeRecordFromJson(json);
...
/// @nodoc
abstract mixin class _$UpgradeRecordCopyWith<$Res> implements $UpgradeRecordCopyWith<$Res> {
  factory _$UpgradeRecordCopyWith(_UpgradeRecord value, $Res Function(_UpgradeRecord) _then) = __$UpgradeRecordCopyWithImpl;
@override @useResult
$Res call({
 int id, int? remoteId, int vehicleId, DateTime date, double mileage, String description, double cost, String notes, List<String> tags, DateTime updatedAt, String syncStatus
});
...
/// @nodoc
class __$UpgradeRecordCopyWithImpl<$Res>
    implements _$UpgradeRecordCopyWith<$Res> {
  __$UpgradeRecordCopyWithImpl(this._self, this._then);

  final _UpgradeRecord _self;
  final $Res Function(_UpgradeRecord) _then;
